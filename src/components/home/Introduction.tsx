  ...
  return (
    ...
    >
      <figure 
        ...
        <img src={BigIdea} alt="big idea" loading='eager' className='object-cover w-full self-center' />
      ...
      <img src={Arrow} alt="arrow" loading='eager' className='md:absolute object-cover w-6 self-center md:bottom-10 md:left-[22rem]' />
      
      <img src={Star} alt="star" loading='lazy' className='absolute left-24 top-32 object-cover w-2 self-center' />
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='monstera relative flex flex-col font-extrabold items-center' >
          ...
          <img src={Star} alt="star" loading='lazy' className='absolute right-3 top-4 object-cover w-2 self-center' />
        </div>
