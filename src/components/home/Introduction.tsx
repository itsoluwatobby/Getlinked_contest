  ...
  return (
    ...
    >
      <figure className='relative w-80 md:w-72 md:flex-none self-center'>
        ...
        <p className='monstera absolute flex flex-col text-sm md:top-[40%] top-1/2 right-[42%] md:right-[40%] text-center z-20 font-bold'>
          <span>The Big</span>
          <span>Idea!</span>
        </p>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex flex-col px-12 md:px-8'>
          <p className='px-4 md:px-0 whitespace-pre-wrap text-justify text-sm leading-loose indent-5 md:indent-0'>
