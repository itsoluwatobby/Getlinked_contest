...
export default function Prizes() {
  const { isIntersecting, observerRef: observerRef20 } = useObserver({screenPosition: '0px', threshold: 0.7})
  ...
  return (
    ...
    >
      ...
      <div className='monstera relative flex md:hidden items-center gap-4 text-[13px] py-8'>
        ...
        <PrizeCard 
          image={Silver_medal} position='2nd' prizeAmount='N300,000' isIntersecting={isIntersecting}
        />

        <PrizeCard 
          image={Gold_medal} position='1st' prizeAmount='N400,000' isIntersecting={isIntersecting}
        />
        
        <PrizeCard 
          image={Bronze_medal} position='3rd' prizeAmount='N150,000' isIntersecting={isIntersecting}
        />
...
const PrizeCard = ({ prizeAmount, image, position, isIntersecting }: CardProps) => {
