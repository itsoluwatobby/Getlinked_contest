...
export default function Criteria() {
  ...
  return (
    ...
    >
      ...
      <div className='monstera flex flex-col md:items-start px-16 md:px-10 gap-4 transition-all'>
        ...
        <p className='whitespace-pre-wrap indent-5 md:indent-0 text-sm leading-loose'>
